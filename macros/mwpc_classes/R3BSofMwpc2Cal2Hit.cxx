...
//bool R3BSofMwpc2Cal2Hit::sortPairsmwpc2(const pair<Double_t, Int_t> &x, const pair<Double_t, Int_t> &y)
...
void R3BSofMwpc2Cal2Hit::Exec(Option_t* option)
{
    ...
    if (qmx_p2>qmx_p1 && padmx_p1 + 1 < Mw2PadsX && padmx_p2 + 1 < Mw2PadsX){
...
R3BSofMwpcHitData* R3BSofMwpc2Cal2Hit::AddHitData(Double_t x, Double_t y, Int_t plane)
{
