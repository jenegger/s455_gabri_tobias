...
void cal_offline(const string& input_str)
{
	...
	filename = string("/u/land/tobias_jenegger/unpacked_s455_data/s455_03_273_") + input_str + string("_unpacked.root");
	...
	outputFilename = string("/u/land/tobias_jenegger/calibrated_s455_data/with_mw/s455_03_273_") + input_str +   string("_calibrated.root");
    ...
    TString sofiacalfilename = "/u/land/antiagg/R3BRoot/sofia/macros/s455Up2p/parameters/CalibParam.par";
   ...
   // TString califadir = dir + "/macros/r3b/unpack/s455/califa/parameters/";
    TString califamapfilename = "/u/land/tobias_jenegger/s455_gabri_tobias/parameters/Califa_Mapping_3March2021.par";
    califamapfilename.ReplaceAll("//", "/");
    // Parameters for CALIFA calibration in keV  --------------------------------
    TString califacalfilename = "/u/land/tobias_jenegger/s455_gabri_tobias/parameters/Califa_CalPar_4March2021.par";
